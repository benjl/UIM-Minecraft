...
kill @e[type=item,nbt={Item:{id:"minecraft:trapped_chest"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:ender_chest"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:dispenser"}}]
kill @e[type=item,nbt={Item:{id:"minecraft:dropper"}}]
...
kill @e[type=item,nbt={Item:{id:"minecraft:hopper"}}]
...
execute as @a at @s run kill @e[type=minecraft:item_frame,distance=0..6]
execute as @a at @s run kill @e[type=minecraft:glow_item_frame,distance=0..6]
