...
# ray: this is a raycast, hit_furnaces: this marker stops at a furnaces, monitor: don't kill this ray after it's cast
summon marker ~ ~ ~ {Tags:["ray", "hit_furnaces", "monitor"]}
