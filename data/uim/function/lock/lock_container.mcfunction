...
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=north] run setblock ~ ~ ~ minecraft:piston[facing=north]
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=south] run setblock ~ ~ ~ minecraft:piston[facing=south]
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=east] run setblock ~ ~ ~ minecraft:piston[facing=east]
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=west] run setblock ~ ~ ~ minecraft:piston[facing=west]
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=up] run setblock ~ ~ ~ minecraft:piston[facing=up]
execute if block ~ ~ ~ #uim:lockables_and_furnaces[facing=down] run setblock ~ ~ ~ minecraft:piston[facing=down]
...
$execute if block ~ ~ ~ minecraft:piston[facing=east] run function uim:lock/setblock {dir: east, id: "$(id)"}
